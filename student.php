...
if (isset($_POST['delete'])){
    ...
    for($i=0;$i<$count;$i++){
        ...
        mysqli_query($conn,"DELETE FROM student WHERE ID = '$id'"); /* EXECUTE QUERY AND USE ' ' (apostrophe) IN YOUR VARIABLE */
...
echo "<h3> <b>Students</b> <h3> <form action='' method='POST'>"; /* SUBMIT PAGE ON ITSELF */
